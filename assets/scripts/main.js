...
function createRecipeCards() {
  console.log('in createRecipeCards');
...
function bindEscKey() {
   ...
   */
  console.log('in bingEscKey'); //debug
...
function bindPopstate() {
   ...
   */
  console.log('in bindPopState'); //debug
